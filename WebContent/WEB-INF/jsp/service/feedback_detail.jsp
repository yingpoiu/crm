...
<html>
  ...
  <c:choose>
    <c:when test="${sessionScope.user.usrRoleId<=3}">
		...
		<input type="hidden" name="svrId" value="${cst.svrId }" />
			<table class="query_form_table" id="table2" >
				<tr>
					...
					<td >
						<input type="text" name="svrResult"  value="" size="53" />
