...
<body>
   <table width="100%" cellSpacing=0 cellPadding=0 border="0px">
	...
	<form action="role/roleupdate.action" method="post">
		...
		<tr>
			...
			<tr>
				<th>描述</th>
				<td><textarea cols="50" rows="4" name="roleDesc">${sessionScope.role.roleDesc}</textarea><span
			...
			<tr>
				...
				<td colspan="3">
				<c:choose>
				<c:when test="${sessionScope.role.roleFlag==1 }"> 
				 <input name="roleFlag" type="radio" value="1"
				 checked="checked"/>有效 
				...
				<c:otherwise >
				<input name="roleFlag" type="radio" value="1"
				/>有效 <input name="roleFlag" type="radio"
			...
			<tr>
				<td width=100% height=32 align=center colspan=6 bgcolor=#ffffff>
					<a href="showhelp.action"><input class="common_button" type="button"
						value="帮助"></a>&nbsp;&nbsp;&nbsp;
<a href="showRolemanage.action"><input
