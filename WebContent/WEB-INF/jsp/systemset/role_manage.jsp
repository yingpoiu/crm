	...
	<table class="query_form_table" cellSpacing=1 cellPadding=1>
		<tr>
			<td width=100% height=30 align=left
				background="images/m_table_top.jpg" colspan="6"><strong>&nbsp;角色管理</strong>
				<c:if test="${sessionScope.user.usrRoleId==1 }">
					<a href="showAddRole.action"><input class="common_button"
						type="button" value="新增"></a>
				</c:if></td>
		</tr>
		<tr>
	</table>
		...
		<c:forEach items="${sessionScope.roles}" var="roles">
			...
			无效
				...
				<td class="list_data_op"><img
					onClick="to('role/${roles.roleId}/editRole.action');" title="编辑"
					src="images/bt_edit.gif" class="op_button" /> <img
					onClick="to('role/${roles.roleId}/deleteRole.action');" title="删除"
