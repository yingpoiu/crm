...
<body>
	...
	<form action="cust/addCustomer.action" method="post"
		...
		<table class="query_form_table">
			<tr>
				...
				<th>名称</th>
				<td><input name="custName" value="" id="cust_name" /><span
			...
			<tr>
				...
				<th>客户经理</th>
				<td>
				    <input name="custManagerName" id="cust_manager_name" value="${sessionScope.user.usrName }"/>
		...
		<table class="query_form_table" id="table1">
			<tr>
				<th>地址</th>
				<td><input name="custAddr" id="cust_addr" value="" /><span
					id="cust_addrspan">*</span></td>
				<th>邮政编码</th>
				<td><input name="custZip" size="20" id="cust_zip" value="" /><span
					class="red_star" id="cust_zipspan">*</span></td>
			</tr>
			<tr>
				<th>电话</th>
				<td><input name="custTel" size="20" id="cust_tel" value="" /><span
					class="red_star" id="cust_telspan">*</span></td>
				<th>传真</th>
				<td><input name="custFax" size="20" id="cust_fax" value="" /><span
		...
		<table class="query_form_table" id="table2">
			...
			<tr>
				<th>注册资金（万元）</th>
				<td><input name="custBankroll" size="20" value="" /></td>
				<th>年营业额</th>
				<td><input name="custTurnover" size="20" value="" /></td>
			</tr>
			<tr>
				<th>开户银行</th>
				<td><input name="custBank" size="20" id="cust_bank" value="" /><span
			...
			<tr>
				<th>地税登记号</th>
				<td><input name="custLocalTaxNo" size="20" value="" /></td>
				<th>国税登记号</th>
