...
<form action="sal/chancesave.action" method="post" onsubmit="return check()">
<table class="query_form_table" cellSpacing=1 cellPadding=1>
	<tr>
			<td width=100% height=30 align=left background = "images/m_table_top.jpg" colspan="6"><strong>&nbsp;新建销售机会</strong></td>
    </tr>
	<tr>
		<th>机会来源</th>
		<td>
	...
	<tr>
		<th>客户名称</th>
		<td><input type="text" name="chcCustName" id="txt" /><span class="red_star">*</span></td>
		<th>成功机率</th>
		<td><input type="text" name="chcRate"/><span class="red_star">*</span></td>
	</tr>	
	<tr>
		<th>概要</th>
		<td><input type="text" name="chcTitle" /><span class="red_star">*</span></td>
		<th>联系地址</th>
		<td ><select name="chcAddr">
	...
	<tr>
		<th>创建人</th>
		<td><input name="chcCreateBy" value="${sessionScope.user.usrName }" readonly size="20" /><span class="red_star">*</span>
		</td>
		<td></td>
	</tr>
	<tr>
